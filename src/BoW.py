...
dataset_type = 'new'
results = []
filenames = ['data/raw_train.csv', 'data/cleaned_train.csv',
             'data/cleaned_stopword_removed_train.csv', 'data/cleaned_lemmatized_train.csv']
ngrams = [1, 2]

table_header_filenames = ['raw', 'cleaned',
                          'cleaned_stopword_removed', 'cleaned_lemmatized']
    ...
    for ngram in ngrams:
        for method in methods:
            for model_type in model_types:
                ...
                results.append({'File': table_header_filename, 'Ngram': ngram, 'Method': method,
